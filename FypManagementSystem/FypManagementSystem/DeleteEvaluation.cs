...
namespace FypManagementSystem
{
    public partial class DeleteEvaluation : Form
    {
        ...
        {
            if (!String.IsNullOrEmpty(textBox1.Text) && !Regex.IsMatch(textBox1.Text, "^[a-zA-Z]+$") || !String.IsNullOrEmpty(textBox1.Text) && !Regex.IsMatch(textBox1.Text, "^[0-9]"))
            {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {*/
                ...
                if (attribute == "Name")
                {
                    query = "DELETE FROM Evaluation WHERE Name = @value";
                }
                else
                {
                    query = "DELETE FROM Evaluation WHERE Marks = @value";
                }
